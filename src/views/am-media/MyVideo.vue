...
export default {
  ...
  methods: {
   // 分页
    ...
    getList() {
      this.$get(`/admin/file/video?type=1&pageNo=${this.currentPage}&startTime=${this.startTime}&endTime=${this.endTime}&pageSize=10`)
      .then( res => {
        this.pageList = res.data;
    ...
    searchList() {
      this.$get(`/admin/file/video?type=1&pageNo=1&pageSize=1000&name=${this.userFileName}&startTime=${this.startTime}&endTime=${this.endTime}`)
      .then( res => {
        this.pageList = res.data;
        this.list = res.data.list
        console.log(res)
